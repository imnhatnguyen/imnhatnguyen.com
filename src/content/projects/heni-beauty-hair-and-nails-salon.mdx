...
summary: Heni Beauty is a project where Nhat created the brand identity and built the website for Heni Beauty Hair and Nails Salon
...
<CloudImage
  ...
  alt='HeNi Beauty social profile picture'
  width={300}
  height={300}
/>
...
The salon owner wants a simple website to showcase the photos of the salon and allow customers to book appointments through Messenger. In addition, the links to the socials of the salon (e.g. Facebook and TikTok) must also be included.
...
- **Wireframing**: As the requirement of the salon owner is a simple website, I only made 2 pages for the website.
  ...
  The first one is the **home page** which includes fundamental information,
  links to the socials, and featured photos of the salon. Then the second page is the
  **gallery page** where all photos are shown.
  ...
  navigation bar sticky as well. In the navigation bar, I also placed a Call-to-action button which triggers the Messenger app for visitors to make appointments.
...
<Video
  src='https://gist.github.com/assets/102733388/c40075b2-bb13-4120-8fdb-4d36ffbcc491'
  width={280}
